...
public class FoodController {
    ...
    @GetMapping
    @ApiResponse(responseCode = "200", description = "All food extracted Successfully.")
    ...
    @GetMapping("/{foodId}")
    @ApiResponse(responseCode = "200", description = "All food extracted by id successfully")
    @Operation(summary = "extract food by id")
